...
void MainWindow::on_pushButton_3_clicked()
{
    QMessageBox::about(this,"Algorithm","This is a storage element calculator, that are consist of capacitor and inductor.\n"
                       "1.This algorithm take the value from input in the spinbox, which is the function(the a,b component), the storage element, and initial V or I.\n"
                                        "2.Then this program require the user to eneter the type of storage elements, type of function, and what function you want.\n"
                                        "Using an if else statement, depending on the what storage element it is, what function it is, and what you want to convert it to,\n"
                                        "There are 3 possible out come, which is no change,integral conversion, and dervative conversion.\n"
                                        "2.1In no change, the function is counted normaly.\n"
                                        "2.2In a integral conversion, the function is change using a integral formula, with the storage element value, and initial V or I.\n"
                                        ...
                                        "2.3In a derivative conversion, the function is change using a derivative formula, with the storage element value.\n"
                                        ...
                                        "3.The function is then counted using a loop from 0->3 second with a 0.01 increment.\n"
                                        "The result of the loop then is change into array in order to be use by the qcustomplot to make a graph.\n"
                                        "4.The output will be the graph, description about the  graph in the textbrowser, the value of t=0, and t=final in the LCD.\n"
                                        "Note: The time interval can be change, to find specific value, and the data also could be saved, and deleted without restarting the program.\n");
}


void MainWindow::on_pushButton_5_clicked()
{
    QMessageBox::about(this,"Program's description","Description\n"
                                                    "This program is a storage element calculator, and it is inspired and made similarly to what Mr. Erikson’s material about storage elements in Electrical Engineering Class, which is about Capacitor and Inductor.\n"
                       ...
                       "The program uses a little bit of everything that has been taught in the first semester. This program used the qcustomplot class to make a graph.This program uses a lot of if-else statements, switch case, break, loop,a little bit of array for the graph, logical operators, and math formula.\n"
                                                    ...
                                                    "Test discussion in video show case or docs(more detailed and result check).\n\n"

"Conclusion\n"
    "To conclude my report, my project for the final exam is a storage element calculator that I made from scratch(except for the qcustomplot class).\n"
                                                    "The project is closely related to my study in mechatronics engineering, especially the electrical engineering part.\n"
                                                    "The formula that I used for this project is taught to me in electrical engineering class by Mr. Erikson.\n"
                                                    "I believe that this project has a little bit of everything that has been taught to me throughout the first semester,\n"
                                                    "showing my understanding of the materials that have been taught to me.\n\n"
                                                    "Reference: Mr. Erikson");}
